...
const Sidebar = ({ user, onClose }) => {
  ...
  return (
    <aside className="w-72 bg-slate-950 text-white h-screen flex flex-col z-40 border-r border-slate-800 shadow-2xl">
      <div className="p-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 bg-blue-600 rounded-2xl flex items-center justify-center font-black text-white italic shadow-lg shadow-blue-600/20 rotate-3">SD</div>
      ...
      <div className="p-6">
        <div className="p-4 bg-slate-900/50 rounded-2xl border border-slate-800 flex items-center gap-4 group cursor-pointer hover:bg-slate-900 transition-all">
          <div className="w-12 h-12 rounded-xl bg-blue-600/10 flex items-center justify-center text-blue-500 font-black text-lg border border-blue-600/20 group-hover:scale-110 transition-transform">
            {user?.name?.charAt(0)}
          </div>
