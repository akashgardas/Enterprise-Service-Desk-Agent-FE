...
import { HiOutlineEnvelope, HiOutlineLockClosed, HiOutlineEye, HiOutlineEyeSlash, HiOutlineExclamationCircle, HiOutlineUserGroup } from 'react-icons/hi2';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg relative">
        <div className="bg-white rounded-[2rem] shadow-2xl shadow-slate-200/60 border border-slate-100 overflow-hidden animate-fade-in">
          <div className="p-10 md:p-14">
            <div className="flex flex-col items-center mb-10">
              ...
              <p className="text-slate-500 mt-2 font-medium">Enterprise Support Portal Login</p>
            </div>

            {error && (
              <div className="mb-8 p-4 bg-red-50 border border-red-100 text-red-700 text-sm rounded-2xl flex items-start gap-3 animate-shake">
          ...
          <div className="bg-slate-50 p-8 text-center border-t border-slate-100">
            <p className="text-sm text-slate-500 font-medium">
              Enterprise Identity Enforced • <span className="text-primary-600 font-bold">SSO Enabled</span>
            </p>
          </div>
        </div>
